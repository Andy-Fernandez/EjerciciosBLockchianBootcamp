...
contract Ejercicio_4 {
    ...
    constructor() {
        owner = msg.sender; // Capture the person who published the smart contract
    }
    ...
    modifier onlyRole(bytes32 _role) {
        require(roles[msg.sender][_role], "You don't have assigned that role.");
        _;
    }
